...
export class ContactsComponent implements OnInit {
  ...
  constructor(private meta: Meta, private gatewayService: GatewayService) {
    ...
    this.meta.updateTag({
      ...
      content: 'Директор, Секретар - +38(0472)36-07-20 | Адміністратор - +38(0472)36-07-18 | Каса - +38(0472)36-07-21 | Eлектронна пошта - theatre.cherkasy@gmail.com | Звертайтеся за адресою - м. Черкаси, бул. Шевченка, 234'
    });
